...
public class Pemesanan extends Fragment {
    ...
    String URL_GET_PEMESANAN = "https://dapnet.tifa.myhost.id/dapnet/api/getpemesanan.php";
    String url = URL_GET_PEMESANAN;
    String URL_UPDATE_PEMESANAN = "https://dapnet.tifa.myhost.id/dapnet/api/updatepemesanan.php";
