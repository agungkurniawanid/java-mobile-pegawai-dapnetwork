...
public class LoginRegister extends AppCompatActivity {
    ...
    private static final String REGISTER_URL = "https://dapnet.tifa.myhost.id/dapnet/api/register.php";
    private static final String LOGIN_URL = "https://dapnet.tifa.myhost.id/dapnet/api/login.php";
    Bitmap bitmap;
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if (status.equals("success")) {
                                    ...
                                    foto_pegawai = "https://dapnet.tifa.myhost.id/dapnet/images/" + jsonResponse.getString("foto_pegawai");
