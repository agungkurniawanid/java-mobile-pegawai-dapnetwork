...
public class Pemesanan extends AppCompatActivity {
    String URL_GET_PAKET_LAYANAN = "https://dapnet.tifa.myhost.id/dapnet/api/getpaket.php";
    String URL_POST_PEMESANAN = "https://dapnet.tifa.myhost.id/dapnet/api/tambahpemesanan.php";
    ...
    private void setCardPaket() {
        String URL_GET = "https://dapnet.tifa.myhost.id/dapnet/api/getpaketlist.php";
        RequestQueue requestQueue = Volley.newRequestQueue(this);
