...
public class MainApplication extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedNamaPegawai = findViewById(R.id.shared_nama_pegawai_ma);
        ...
        // todo untuk set foto pegawai login
    ...
    private void getSharedData(String nama) {
        String URL = "https://dapnet.tifa.myhost.id/dapnet/api/getshared.php?id=" + nama;
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (status.equals("success")) {
                        ...
                        fotoPegawai = "https://dapnet.tifa.myhost.id/dapnet/images/" + dataPegawai.getString("foto_pegawai");
                        ;
