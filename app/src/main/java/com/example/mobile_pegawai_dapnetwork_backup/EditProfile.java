...
public class EditProfile extends AppCompatActivity {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (foto_url != null) {
                            ...
                            String URL = "https://dapnet.tifa.myhost.id/dapnet/api/editprofile.php?id=" + idPegawai;
    ...
    private void getDataPegawai(String idpegawai) {
        String URL = "https://dapnet.tifa.myhost.id/dapnet/api/getdatapegawai.php?id=" + idpegawai;
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (status.equals("success")) {
                        ...
                        foto_url = "https://dapnet.tifa.myhost.id/dapnet/images/" + dataPegawai.getString("foto_pegawai");
